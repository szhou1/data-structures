describe('hashTable', function() {
  ...
  // it ('should double in size when needed 7 people', function() {
  ...
  it ('should double in size when needed with 10 elements', function() {
    _.each([["a","aaa"],["b","bbb"],["c","ccc"],["d","ddd"],
    ["e","eee"],["f","fff"],["g","ggg"],["h","hhh"],
    ["i","iii"],["j","jjj"]],
      function(string) {
      var one = string[0];
      var two = string[1];
      hashTable.insert(one, two);
      expect(hashTable.retrieve(one)).to.equal(two);
    });
    expect(hashTable._limit).to.equal(16);
  });

  it ('should double in size twice to 32 when needed with 13 elements', function() {
    _.each([["a","aaa"],["b","bbb"],["c","ccc"],["d","ddd"],
    ["e","eee"],["f","fff"],["g","ggg"],["h","hhh"],
    ["i","iii"],["j","jjj"],["k","kkk"],["l","lll"],["m","mmm"]],
      function(string) {
      var one = string[0];
      var two = string[1];
      hashTable.insert(one, two);
